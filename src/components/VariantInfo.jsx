...
export default function VariantInfo({results,no}){
    ...
    const ref_allele = data.ref_allele
    const alt_allele = data.alt_allele
                                ...
                                <CardContent>
                                    ...
                                    >
                                        <List>
                                            ...
                                            <ListItem sx = {{pt: ref_allele.length > 20 ? 4:1}}>
                                                <Typography sx = {{fontWeight: 600}}>
                                                    Alternate Allele: 
                                                </Typography>
                                            </ListItem>
                                            <ListItem sx = {{pt: alt_allele.length > 20 ? 4:1}}>
                                                <Typography sx = {{fontWeight: 600}}>
                                                    Consequence: 
                                                </Typography>
                                            </ListItem>
                                            ...
                                            <ListItem >
                                                <Typography>
                                                    {ref_allele.length < 20 ? 
                                                        ...
                                                        ref_allele:
                                                        <> {ref_allele.slice(0,25)} <br /> {ref_allele.slice(15)} </>
                                                    }
                                                </Typography>
                                            </ListItem>
                                            <ListItem>
                                                <Typography>
                                                    {alt_allele.length < 20 ? 
                                                        ...
                                                        alt_allele:
                                                        <> {alt_allele.slice(0,25)} <br /> {alt_allele.slice(15)} </>
                                                    }
                                                </Typography>
                                            </ListItem>
                                            <ListItem>
