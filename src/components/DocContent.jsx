                ...
                >
                    ...
                    <Typography variant = 'body1' sx = {{py: 3}}> 
                        ...
                        <List>
                            ...
                            <Example> 
                                <Typography fontWeight={500}> stop loss </Typography>
                    ...
                    <Typography variant = 'body1' sx = {{py: 3}}> 
                        ...
                        <List>
                            <ListItem> 1. Searching by consequence </ListItem>
                            <Example> 
                                <Typography fontWeight={500}> stop loss[consequence] </Typography>
                                <Typography variant = 'caption'> Searches for all variants whose consequence is missense. </Typography> 
                            </Example>
                        ...
                        <List>
                            ...
                            <Example> 
                                <Typography fontWeight={500}> stop gain, inframe deletion[consequence] </Typography>
                                <Typography variant = 'caption'> Searches for all variants whose consequence is either a stop gain or an inframe deletion. </Typography> 
                            </Example>
                            ...
                            <Example> 
                                ...
                                <Typography variant = 'caption'> Searches for the variants in the genomic position 1007432, 1019175 snd 876499</Typography> 
                            </Example>
                            <ListItem> 8. Searching by chromosome number and consequence </ListItem>
                            <Example> 
                                <Typography fontWeight={500}> 1,3[chr] AND splice region,intronic[consequence] </Typography>
                            ...
                            <Example> 
                                <Typography fontWeight={500}> stop gain, inframe deletions[consequence] AND samd11,scnn1d[gene]</Typography>
                                <Typography variant = 'caption'> Searches for all variants whose consequence is either a stop gain or an inframe deletion and found in SAMD11 and SCNN1D gene regions. </Typography> 
                            </Example>
                        </List>
